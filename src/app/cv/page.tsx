  ...
  return (<>
    ...
    <header>
      <div className="heading">
        <h1 className="title">Alex Brown</h1>
      ...
      <ul className="contacts">
        ...
        <li>
          ...
          <address>
            <a href="https://alexbrown.nz/">alexbrown.nz</a>
          </address>
        </li>
        <li>
          <FontAwesomeIcon icon={faPhone} />
          <address>
            <a className="nostyle" target="_blank"></a>
            <ObfuscatedLink className="nostyle" target="_blank" text="gMzITNgEjMwACNwIDI0YzK" href={(text: string) => "tel:" + text.replaceAll(" ", "-")} placeholder="+64 000 000 0000" />
          </address>
        </li>
        <li>
          <FontAwesomeIcon icon={faLinkedin} />
          <address>
            <a href="https://www.linkedin.com/in/alex-b-nz/" target="_blank">alex-b-nz</a>
          </address>
        </li>
        <li>
          <FontAwesomeIcon icon={faGithub} />
          <address>
            <a href="https://github.com/AlexApps99" target="_blank">AlexApps99</a>
          </address>
        </li>
        <li>
          <FontAwesomeIcon icon={faEnvelope} />
          <address>
            <ObfuscatedLink target="_blank" text="t92YuwWah12ZAlTOzBHch5CelxWY" href={(text: string) => "mailto:" + text} placeholder="enable.js@example.org" />
          </address>
        </li>
      </ul>
    </header>
    ...
    <main>
      ...
      <section>
        <h2><FontAwesomeIcon icon={faBriefcase} /> Industry experience</h2>
      ...
      <section>
        <h2><FontAwesomeIcon icon={faUsers} /> Club projects</h2>
      ...
      <section>
        <h2><FontAwesomeIcon icon={faAward} /> Achievements</h2>
        <ul className="thick">
          <li>
      ...
      <section>
        <h2><FontAwesomeIcon icon={faMicrochip} /> Technical skills</h2>
        <ul className="thick">
          <li>
            <b>Linux</b>:
      ...
      <section>
        <h2><FontAwesomeIcon icon={faFlask} /> Personal projects</h2>
        <ul className="thick">
          <li>
      ...
      <section>
        <h2><FontAwesomeIcon icon={faUserCheck} /> References</h2>
        <p>
